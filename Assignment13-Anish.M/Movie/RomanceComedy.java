...
public class RomanceComedy extends Movie {
    
    RomanceComedy(String title, String director, float rating, int duration, String genre, String releaseDate, String description,String[] cast,String language,String review) {
