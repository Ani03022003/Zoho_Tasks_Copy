...
//import com.example.andfunkotlinandroidtriviastartercode.databinding.FragmentGameOverBinding
...
class GameOverFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Toast.makeText(context,"OOPSSSS!!......${args.numCorrect} out of ${args.numQuestions}",Toast.LENGTH_LONG).show()
