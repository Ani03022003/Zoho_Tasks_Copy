...
//import com.example.andfunkotlinandroidtriviastartercode.databinding.FragmentGameWonBinding
...
class GameWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Toast.makeText(context,"${args.numCorrect} out of ${args.numQuestions} WWWWOOOOOWWWWWW COOLLLLL!!!",Toast.LENGTH_LONG).show()
